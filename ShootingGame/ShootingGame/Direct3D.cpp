...
bool Direct3D::Initialize(HWND hWnd, int width, int height)
{
	...
	{
		D3D_FEATURE_LEVEL_11_1,//ShaderModel 5
		D3D_FEATURE_LEVEL_11_0,//ShaderModel 5
		D3D_FEATURE_LEVEL_10_1,//ShaderModel 4
		D3D_FEATURE_LEVEL_10_0,//ShaderModel 4
		D3D_FEATURE_LEVEL_9_3,//ShaderModel 3
		D3D_FEATURE_LEVEL_9_2,//ShaderModel 3
		D3D_FEATURE_LEVEL_9_1,//ShaderModel 3
	};
	...
	scDesc.BufferDesc.ScanlineOrdering = DXGI_MODE_SCANLINE_ORDER_UNSPECIFIED;//スキャンラインの順序
	scDesc.BufferDesc.Scaling = DXGI_MODE_SCALING_UNSPECIFIED;//スケーリング
	scDesc.BufferDesc.RefreshRate.Numerator = 0;
	scDesc.BufferDesc.RefreshRate.Denominator = 1;
	scDesc.SampleDesc.Count = 1;  //MSAAは使わない
	scDesc.SampleDesc.Quality = 0;  //MSAAは使わない
	scDesc.BufferUsage = DXGI_USAGE_RENDER_TARGET_OUTPUT;//バッファの使用法
